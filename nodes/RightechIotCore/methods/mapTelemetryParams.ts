...
export async function mapTelemetryParams(this: ILoadOptionsFunctions): Promise<ResourceMapperFields> {
    ...
    try {
        ...
        const telemetryParams = modelData._arguments
            ...
            .sort((a, b) => (a._base ? (b._base ? 0 : -1) : 1)
        ...
        return {
            ...
            emptyFieldsNotice: telemetryParams.length === 0 ? "Object does not have any routed telemetry parameters." : undefined,
        }
    } catch (error) {
        return {
            fields: [],
